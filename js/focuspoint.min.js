!function(t, e) {
    ...
    IFA.Models.Attachment = Backbone.Model.extend({
        ...
        initialize: function(t) {
            ...
            this.$img = t.$img, this.fetchAttachmentData(), this.on("change:focusPointOrigin", function() {
                e.setDifferState(!0);
            }, this), this.on("change:differState", this.resetAjaxState, this), e.setDifferState();
        },
        fetchAttachmentData: function() {
            var e = this;
            this.set("ajaxState", "fetching"), this.fetch({
                ...
                error: function(t, i, s) {
                    console.log(i), e.set("ajaxState", !1);
                }
            });
        },
        saveAttachmentData: function() {
            ...
            this.set("ajaxState", "cropping"), this.save({}, {
                ...
                error: function(e, i, s) {
                    console.log(i), t.set("ajaxState", "failed");
                }
            });
        },
        ...
        resetAjaxState: function() {
            !0 === this.differState && this.model.set("ajaxState", !1);
        },
    ...
    IFA.Views.Attachment = Backbone.View.extend({
        initialize: function(i, s) {
            ...
            this.model.on("change:ajaxState", this.updateDimensions, this), this.focusInterface.on("change:activeState", this.updateDimensions, this);
        },
    ...
    IFA.Views.Cropbutton = Backbone.View.extend({
        ...
        initialize: function(e, i) {
            ...
            this.model.on("change:text", this.render, this), this.ajaxStateHandler().differStateHandler().render();
        },
        render: function() {
            var t = this.model.get("text"), e = this.model.get("disableState"), i = this.model.get("highlightState");
            return this.$cropButton.toggleClass(IFA.css.button._disabled, e), this.$cropButton.toggleClass(IFA.css.button._primary, i), 
            this.$cropButton.text(t), this;
        },
        differStateHandler: function() {
            return !0 === this.attachment.get("differState") ? (this.model.set("text", focusPointL10n.cropButton), 
            this.highlight()) : this.disable(), this;
        },
        ajaxStateHandler: function() {
            switch (this.attachment.get("ajaxState")) {
              ...
              case "fetching":
                this.model.set("text", focusPointL10n.cropButtonFetching), this.disable();
                break;
    ...
    IFA.Views.FocusInterface = Backbone.View.extend({
        ...
        initialize: function(t, e) {
            ...
            this.attachment.once("change:focusPoint", this.updateFocusPoint, this), this.attachment.on("change:ajaxState", this.updateDimensionData, this), 
            this.setStateEvent("hoverState", "is-hover"), this.setStateEvent("activeState", "is-active"), 
            this.setStateEvent("moveState", "is-move"), this.setStateEvent("initState", "is-initialized");
        },
        events: {},
        render: function() {
        ...
        move: function(t) {
            ...
            var e = {
                x: t.pageX,
                y: t.pageY
            }, i = {}, s = this.attachment.get("offset"), n = this.model.get("clickPosition"), a = this.attachment.get("width"), o = this.attachment.get("height");
            i.x = e.x - s.x - n.x, i.y = e.y - s.y - n.y, i.x = IFA.CalcService.minMaxRange(i.x, 0, a), 
            i.y = IFA.CalcService.minMaxRange(i.y, 0, o);
            var c = {};
            return c.x = i.x / a * 100, c.y = i.y / o * 100, this.attachment.set({
                focusPoint: c
            }), this.model.set({
                position: i
            }), this;
        ...
        updateFocusPoint: function() {
            var t = this.attachment.get("focusPoint"), e = this.model.get("position"), i = this.model.get("radius"), s = this.attachment.get("width"), n = this.attachment.get("height"), a = this.attachment.get("src"), o = {};
            return o.x = 0 - (e.x - i), o.y = 0 - (e.y - i), this.$focusPoint.css({
                left: t.x + "%",
                top: t.y + "%",
