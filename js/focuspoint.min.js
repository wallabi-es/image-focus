!function(t, i) {
    ...
    IFA.Models.Attachment = Backbone.Model.extend({
        ...
        hasChanged: function(t) {
            var i = this, e = this.get("focusPointOrigin"), s = this.get("focusPoint"), o = !1;
            e.x !== s.x && (o = !0), e.y !== s.y && (o = !0), this.set("focusPointDiffers", o), 
            !0 !== t && !1 !== o || this.once("change:focusPoint", function() {
                i.hasChanged(!1);
            }, this);
        }
    });
    ...
    IFA.Models.FocusInterface = Backbone.Model.extend({
        ...
        setState: function(t) {
            var i = this.get("state") || {};
            _.extend(i, t), this.set({
                state: i
            });
        }
    });
    ...
    IFA.Views.Actions = Backbone.View.extend({
        ...
        initialize: function(i, e) {
            var s = this, o = '<button type="button" class="' + this.cssClass._button + " " + this.cssClass.button._disabled + " crop-attachment " + this.cssClass.imageFocus._button + '">' + focusPointL10n.cropButton + "</button>";
            this.$el.append(o), this.$cropButton = t("." + this.cssClass.imageFocus._button), 
            this.$cropButton.on("click", function() {
                s.model.save({}, {
                    url: ajaxurl + "?action=initialize-crop",
                    success: function(t, i, e) {
                        if (!0 === i.success) try {
                            if (!i.focusPoint.hasOwnProperty("x") || !i.focusPoint.hasOwnProperty("y")) throw "Wrong object properties";
                            s.model.set({
        ...
        handler: function() {
            !0 === this.model.get("focusPointDiffers") ? this.highlight() : this.disable();
        },
        highlight: function() {
            this.$cropButton.removeClass(this.cssClass.button._disabled).addClass(this.cssClass.button._primary).text(focusPointL10n.cropButton);
        },
        activate: function() {
            this.$cropButton.removeClass(this.cssClass.button._disabled).removeClass(this.cssClass.button._primary);
        },
        disable: function() {
            this.$cropButton.removeClass(this.cssClass.button._primary).addClass(this.cssClass.button._disabled);
        }
    });
}(jQuery, window), function(t, i) {
    "use strict";
    ...
    IFA.Views.FocusInterface = Backbone.View.extend({
        ...
        setEvents: function() {
            ...
            this.$clickarea.on("mousedown", function(t) {
                1 === t.which && e.startMove(t, !0).move(t);
            }), this.$focusPoint.on("mousedown", function(t) {
                1 === t.which && e.startMove(t);
            }).on("mouseenter", function() {
                e.model.setState({
                    hover: !0
                }), e.$imageFocus.toggleClass("is-hover", !0);
            }).on("mouseleave", function() {
                e.model.setState({
                    hover: !1
                }), e.$imageFocus.toggleClass("is-hover", !1);
            }), t(i).on("mouseup", function(t) {
                1 === t.which && (e.model.setState({
                    move: !1,
                    active: !1
                }), e.$imageFocus.removeClass("is-active"));
            }).on("mousemove", function(t) {
                e.move(t);
            }).on("resize", function() {
                e.updateDimensionData().updateFocusPoint();
            });
        },
        startMove: function(t, i) {
            return this.updateDimensionData().updateClickPosition(t, i), this.$imageFocus.addClass("is-active"), 
            this.model.setState({
                move: !0,
                active: !0
            }), this;
        ...
        move: function(t) {
            ...
            var i = {
                x: t.pageX,
                y: t.pageY
            }, e = {}, s = this.attachment.get("offset"), o = this.model.get("clickPosition"), n = this.attachment.get("width"), a = this.attachment.get("height");
            e.x = i.x - s.x - o.x, e.y = i.y - s.y - o.y, e.x = this.helper.calc.maxRange(e.x, 0, n), 
            e.y = this.helper.calc.maxRange(e.y, 0, a);
            var c = {};
            return c.x = e.x / n * 100, c.y = e.y / a * 100, this.attachment.set({
                focusPoint: c
            }), this.model.set({
                position: e
            }), this;
        ...
        updateFocusPoint: function() {
            var t = this.attachment.get("focusPoint"), i = this.model.get("position"), e = this.model.get("radius"), s = this.attachment.get("width"), o = this.attachment.get("height"), n = this.attachment.get("src"), a = {};
            return a.x = 0 - (i.x - e), a.y = 0 - (i.y - e), this.$focusPoint.css({
                left: t.x + "%",
                top: t.y + "%",
        ...
        updateDimensionData: function() {
            ...
            var e = this.attachment.get("focusPoint"), s = {
                x: e.x / 100 * this.attachment.get("width"),
                y: e.y / 100 * this.attachment.get("height")
            };
            return this.model.set({
                position: s
            }), this;
