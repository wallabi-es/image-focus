!function(t, i) {
    ...
    IFA.Views.Actions = Backbone.View.extend({
        ...
        initialize: function(i, e) {
            var s = '<button type="button" class="' + this.cssClass._button + " " + this.cssClass.button._disabled + " crop-attachment " + this.cssClass.imageFocus._button + '">' + focusPointL10n.cropButton + "</button>";
            this.$el.append(s), this.$cropButton = t("." + this.cssClass.imageFocus._button), 
