!function(t, e) {
    ...
    IFA.Views.Cropbutton = Backbone.View.extend({
        ...
        initialize: function(e, i) {
            ...
            this.$el.append(s), this.$cropButton = t("." + IFA.css.imageFocus._button), this.$cropButton.on("click", _.bind(this.saveAttachment, this)), 
        ...
        saveAttachment: function() {
            var t = this;
            this.attachment.set("ajaxState", "cropping"), this.attachment.save({}, {
                url: ajaxurl + "?action=initialize-crop",
                success: function(e, i, s) {
                    if (!0 === i.success) try {
                        t.attachment.validateFocusPoint(i), t.attachment.set({
                            focusPointOrigin: i.focusPoint
                        }), t.attachment.set("ajaxState", "success");
                    } catch (e) {
                        console.log(e), t.attachment.set("ajaxState", "failed");
                    }
                },
                error: function(e, i, s) {
                    t.attachment.set("ajaxState", "failed"), console.log(i);
                }
            });
        },
