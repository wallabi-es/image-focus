!function(t, e) {
    ...
    IFA.Views.FocusInterface = Backbone.View.extend({
        ...
        initialize: function(i, o) {
            ...
            this.render(), this.model.on("change", this.render, this), this.$clickarea.on("mousedown", function(t) {
        ...
        move: function(t) {
            ...
            this.attachment._focusPoint = n, this.model._position = i, this.updateStyle(), this;
        },
        ...
        state: {
            hover: function(t) {
                this.model._state.hover = t, this.$imageFocus.toggleClass("is-hover", t);
            }
        },
        helper: {
            calc: {
