!function(t, i) {
    ...
    IFA.Views.FocusInterface = Backbone.View.extend({
        ...
        initialize: function(t, i) {
            ...
            this.render(), this.model.on("change:_position", this.updateFocusPoint, this), this.attachment("change:_focusPoint", this.updateFocusPoint, this);
        },
        events: {},
        render: function() {
        ...
        move: function(t) {
            ...
            this.attachment.setFocusPoint(n), this.model.setPosition(e), this;
        },
        updateFocusPoint: function() {
            console.log("updateFocusPoint");
            var t = this.attachment.get("_focusPoint"), i = this.model.get("_position"), e = this.model.get("_radius");
            console.log("radius");
            var s = {};
            return s.x = 0 - (i.x - e), s.y = 0 - (i.y - e), console.log(s), this.$focusPoint.css({
                left: t.x + "%",
                top: t.y + "%",
