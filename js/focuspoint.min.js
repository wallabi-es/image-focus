!function(t, i) {
    ...
    IFA.Models.Attachment = Backbone.Model.extend({
        ...
        initialize: function(t) {
            this.$el = t.$el, this.$img = t.$img;
            var i = this.$el.data("id");
            this.id = i, this.set("id", i), this.set("src", this.$img.attr("src"));
        },
    ...
    IFA.Views.Actions = Backbone.View.extend({
        ...
        disable: function() {
            this.$cropButton.removeClass(cssClass.button._primary).addClass(cssClass.button._disabled);
        }
    });
}(jQuery, window), function(t, i) {
    "use strict";
    ...
    IFA.Views.ImageFocus = Backbone.View.extend({
        ...
        startApplication: function(t) {
            ...
            e.getStoredFocusPoint(), s.set("state.init", !0);
        }
    });
}(jQuery, window);
