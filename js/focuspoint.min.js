!function(t, i) {
    ...
    function e(t) {
        ...
        e.getStoredFocusPoint(), s.set("_state.init", !0);
    }
    i.IFA = {
        Models: {},
        Collections: {},
    ...
    IFA.Models.Attachment = Backbone.Model.extend({
        ...
        initialize: function(t) {
            this.$el = t.$el, this.$img = t.$img, this._id = this.$el.data("id"), this._src = this.$img.attr("src");
        },
        setFocusPoint: function(t) {
            var i = this.get("_focusPoint") || {};
    ...
    IFA.Views.FocusInterface = Backbone.View.extend({
        ...
        initialize: function(t, i) {
            ...
            this.render(), this.model.on("change:_position", this.updateFocusPoint, this), this.attachment.on("change:_focusPoint", this.updateFocusPoint, this);
        },
        events: {},
        render: function() {
        ...
        startMove: function(t, i) {
            return this.updateDimensionData().updateClickPosition(t, i), this.model.setState({
                move: !0,
                active: !0
            }), this;
        },
        move: function(t) {
            if (!1 === this.model.get("_state").move) return !1;
            var i = {
                x: t.pageX,
                y: t.pageY
            }, e = {}, s = this.attachment._offset, o = this.model._clickPosition;
            e.x = i.x - s.x - o.x, e.y = i.y - s.y - o.y, e.x = this.helper.calc.maxRange(e.x, 0, this.attachment._width), 
        ...
        updateFocusPoint: function() {
            var t = this.attachment.get("_focusPoint"), i = this.model.get("_position"), e = this.model.get("_radius"), s = {};
            return s.x = 0 - (i.x - e), s.y = 0 - (i.y - e), this.$focusPoint.css({
                left: t.x + "%",
                top: t.y + "%",
